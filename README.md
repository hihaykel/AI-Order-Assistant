...
* **100% Autopilot:** Uses an `On edit` or time-driven Trigger to process incoming messages hands-free.
...
3. (Optional) Create a secondary tab or document outlining your **Company Rules** (e.g., Order Tracking, Damage Claims, 7-day Exchanges).

### 2. Apps Script Integration
1. Inside your Google Sheet, navigate to **Extensions > Apps Script**.
2. Delete any existing code and paste the code from the `app-script.js` file in this repository.

### 3. Get a Gemini API Key
1. Go to [Google AI Studio](https://aistudio.google.com/).
2. Click on **Create API Key**.
3. Copy your key and paste it at the top of your Apps Script file:
   ```javascript
